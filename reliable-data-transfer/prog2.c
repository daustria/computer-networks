...
void save_last_sent_packet(pkt_t packet)
{
	...
	strcpy(a_state->tmp_packet.payload, packet.payload);
}
...
void A_init()
{
	...
	// TODO copy assignment operator doesnt work like this in C. 
...
// TODO : Clear malloc redefinitions. Some old K&R C -style thing
